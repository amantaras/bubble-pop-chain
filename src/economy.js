...
export const POWERUP_INFO = {
  undo: { name: "Undo", icon: "↶", iconAsset: "assets/icons/tools/undo.png", desc: "Takes back your last move", price: 90 },
  bomb: { name: "Bomb", icon: "💥", iconAsset: "assets/icons/tools/bomb.png", desc: "Clears a 3×3 area", price: 150 },
  colorClear: { name: "Color Clear", icon: "🌈", iconAsset: "assets/icons/tools/color-clear.png", desc: "Removes one whole color", price: 250 },
  paint: { name: "Paint", icon: "🎨", iconAsset: "assets/icons/tools/paint.png", desc: "Changes one bubble to a smart suggested color", price: 180 },
  shuffle: { name: "Shuffle", icon: "🔀", iconAsset: "assets/icons/tools/shuffle.png", desc: "Reshuffles the board", price: 100 },
  chainBolt: { name: "Chain Bolt", icon: "⚡", iconAsset: "assets/icons/tools/chain-bolt.png", desc: "Clears a full row and column", price: 300 },
  pick: { name: "Pick", icon: "🔨", iconAsset: "assets/icons/tools/pick.png", desc: "Removes a single bubble", price: 120 },
  extraMoves: { name: "+3 Moves", icon: "＋", iconAsset: "assets/icons/tools/extra-moves.png", desc: "Adds 3 moves to a move-limited level", price: 360, moves: 3 },
  magnet: { name: "Magnet", icon: "🧲", iconAsset: "assets/icons/tools/magnet.png", desc: "Pull same-color bubbles together — time the gauge!", price: 500 },
};
