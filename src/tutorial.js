...
export const TUTORIAL_STEPS = [
  ...
  },
  {
    id: "done",
    title: "You're ready!",
    body: "That's everything — pop chains, plan combos, and clear the board. Check the briefing before a run, then finish a level to compare it with your recap: score, moves, best chain, tools used, stars, objectives, and coins earned. Have fun!",
    advance: "button",
    cta: "Start playing",
  },
];
